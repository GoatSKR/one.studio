...
export default function Audience() {
    ...
    return (
        <div className="bg-[#121211] h-auto pt-[80px] pb-[50px] md:pb-[120px] z-30 relative" >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-2 md:mx-10">
                <div className="bg-[#4182e4] rounded-xl h-[600px] py-[90px] px-[60px]">
                    <h1 className="text-white text-3xl md:text-6xl ">"An audience that is tired of big words and empty promises"</h1>
                </div>
